...
public class NutritionDbIntializerlizer : IDbIntializer
{
        private readonly NutritionDbContext _context;
        private readonly ILogger<NutritionDbIntializerlizer> _logger;

        public NutritionDbIntializerlizer(NutritionDbContext context,ILogger<NutritionDbIntializerlizer> logger)
        {
            _context = context;
            _logger = logger;
        }
